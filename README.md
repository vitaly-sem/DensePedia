# DensePedia — База знаний Senior-инженера <sup style="font-size:0.6em;color:var(--text-tertiary, #888);font-weight:400;">v1.1</sup>

![DensePedia](promo_slide.png)

> 44 тематических раздела · 200+ структурированных статей · факты, код, чек-листы
>
> **DensePedia** — это систематизированный справочник для инженера, который хочет
> не просто знать технологию, а понимать её изнутри. Архитектура и алгоритмы,
> безопасность и фреймворки, системный дизайн и софт-скиллы — каждый раздел
> построен вокруг плотной выжимки знаний, применимых в реальной работе и на
> технических интервью.
>
> От внутренностей GC и lock-free структур до истории XX века и философии —
> материалы охватывают как профессиональный стек, так и горизонтальные дисциплины,
> формирующие широкий кругозор Senior-инженера.
...
DensePedia — структурированная база знаний Senior-инженера: 40+ разделов, 200+ статей
с фактами, примерами кода и чек-листами — от безопасности и архитектуры до фреймворков
и системного дизайна. Материалы разделены на 4 тематические группы; каждая секция имеет формат `NXX`,
где `N` — номер группы, `XX` — номер внутри группы.

| Группа | Секции | О чём |
|--------|--------|-------|
| **💻 Программирование** | 001–021 | .NET, Web, БД, архитектура |
| **🚀 Развитие и инфраструктура** | 101–109 | Стартапы, здоровье, финансы, DevOps, софт-скиллы |
...
<details>
<summary><strong>💻 Программирование</strong> (секции 001–021)</summary>
...
| 🖥️ [021 — Avalonia & XAML Mobile](021-avalonia-xaml-mobile/README.md) | 2 | Avalonia, MAUI, Uno, библиотеки, WPF vs Avalonia |

</details>

<details>
<summary><strong>🚀 Развитие и инфраструктура</strong> (секции 101–109)</summary>
...
| 🎓 [104 — Университеты мира](104-universities/README.md) | 5 | История, национальные системы, рейтинги, CIS, сравнение моделей |
...
| 🏢 [108 — Microsoft Dynamics 365](108-dynamics365/README.md) | 6 | D365 экосистема, F&O, BC, Power Platform, X++, миграция данных |
| 🎯 [109 — Собеседование — полная подготовка](109-interview-preparation/README.md) | 15 | .NET, синхронизация, GC, System Design, архитектура, алгоритмы, PostgreSQL, Kafka, NoSQL, шардирование, кеширование, DDD, HA, CAP |
...
### [🖥️ 021 — Avalonia & XAML Mobile](021-avalonia-xaml-mobile/README.md)

| # | Раздел | Файл |
|---|--------|------|
| 1 | Avalonia UI, .NET MAUI, Uno Platform — сравнение и архитектура | [01-avalonia-xaml-mobile.md](021-avalonia-xaml-mobile/01-avalonia-xaml-mobile.md) |
| 2 | Библиотеки, возможности vs WPF, новое за 2 года | [02-avalonia-libraries-features.md](021-avalonia-xaml-mobile/02-avalonia-libraries-features.md) |
...
### [🎓 104 — Университеты мира](104-universities/README.md)

| # | Раздел | Файл |
|---|--------|------|
| 1 | История и типы университетов | [01-history-types.md](104-universities/01-history-types.md) |
| 2 | Национальные системы образования | [02-country-systems.md](104-universities/02-country-systems.md) |
| 3 | Ведущие университеты и рейтинги | [03-top-universities.md](104-universities/03-top-universities.md) |
| 4 | Специализированные и альтернативные институты | [04-specialized-alternative.md](104-universities/04-specialized-alternative.md) |
| 5 | Сравнение моделей обучения | [05-comparison-models.md](104-universities/05-comparison-models.md) |
| 6 | Университеты стран СНГ | [06-cis-countries.md](104-universities/06-cis-countries.md) |
...
### [🏢 108 — Microsoft Dynamics 365](108-dynamics365/README.md)

| # | Раздел | Файл |
|---|--------|------|
| 1 | [Обзор экосистемы Dynamics 365](108-dynamics365/01-dynamics365-overview.md) | Все приложения D365, лицензирование, Power Platform, CDM, сравнение с конкурентами |
2 | [Finance & Operations — глубокое погружение](108-dynamics365/02-finance-operations.md) | Finance, SCM, Manufacturing, Globalization, LCS, интеграции |
3 | [Техническая архитектура и разработка](108-dynamics365/03-technical-architecture.md) | X++, MorphX, Extensions, CoC, CI/CD, OData, Dual-write |
4 | [Business Central — ERP для SMB](108-dynamics365/04-business-central.md) | NAV → BC эволюция, AL Language, Extensions V2, сравнение с F&O |
5 | [Power Platform и интеграция](108-dynamics365/05-power-platform-integration.md) | Power Apps, Automate, BI, Dataverse, Dual-write, Copilot, AI Builder |
6 | [Управление данными и миграция](108-dynamics365/06-data-management-migration.md) | DMF, Data Entities, стратегии миграции, BYOD, Data Lake |

---

### [🎯 109 — Собеседование — Полная подготовка](109-interview-preparation/README.md)

# | Раздел | Файл |
|---|--------|------|
| 1 | [.NET Collections — глубокое погружение](109-interview-preparation/01-dotnet-collections-advanced.md) | List, Dictionary, HashSet, SortedSet, Concurrent*, Immutable collections; сложность |
2 | [Синхронизация и модель памяти](109-interview-preparation/02-synchronization-memory-model.md) | lock/Monitor, Interlocked (CAS), volatile, memory barriers, lock-free, ABA, AsyncLocal |
3 | [GC, стек/куча и Async-подводные камни](109-interview-preparation/03-gc-heap-async-pitfalls.md) | GC поколения, стек vs куча, boxing, deadlock .Result, ConfigureAwait, ThreadPool starvation |
4 | [System Design — методология](109-interview-preparation/04-system-design-methodology.md) | Сбор требований, оценка ресурсов, high-level design, API, детальный компонент, отказоустойчивость |
5 | [Архитектурные паттерны — практика](109-interview-preparation/05-architecture-patterns-real-world.md) | SOLID (5 примеров), микросервисы, Saga, Circuit Breaker, DDD (стратегический/тактический дизайн) |
6 | [Алгоритмы, сложность и графы](109-interview-preparation/06-algorithms-complexity-graphs.md) | Big O, QuickSort/MergeSort/HeapSort, BFS/DFS, Dijkstra, A*, Two Pointers, Sliding Window |
7 | [PostgreSQL — запросы и оптимизация](109-interview-preparation/07-postgresql-query-optimization.md) | EXPLAIN ANALYZE, B-tree/GIN/GiST/BRIN, MVCC, VACUUM, партиционирование |
8 | [Kafka и очереди сообщений](109-interview-preparation/08-kafka-message-queues.md) | Архитектура, партиции, consumer groups, delivery semantics, Kafka Streams, vs RabbitMQ |
9 | [Kafka Advanced — тонкости](109-interview-preparation/09-kafka-advanced.md) | Exactly-once (idempotent/transactional), compaction, KRaft, producer/consumer tuning, мониторинг lag |
10 | [PostgreSQL Advanced — репликация, шардирование](109-interview-preparation/10-postgresql-advanced.md) | Streaming/Logical репликация, Citus, PgBouncer, GIN JSONB, расширения, VACUUM tuning, XID wrap-around |
11 | [Шардирование, репликация, кеширование + NoSQL](109-interview-preparation/11-sharding-replication-caching.md) | Hash/Range/Geo/Consistent Hashing, Quorum репликация, Cache-Aside/Write-Through/Write-Behind, Redis Cluster, Redlock, NoSQL (Cassandra/MongoDB/Redis vs PostgreSQL) |
12 | [System Design — реальные кейсы](109-interview-preparation/12-system-design-real-cases.md) | Twitter (News Feed fan-out), Uber (H3 geo-индексация), WhatsApp (Cassandra + presence), YouTube (transcoding + CDN) |
13 | [Domain-Driven Design — продвинутый уровень](109-interview-preparation/13-ddd-advanced.md) | Bounded Contexts (ACL), Aggregate Design (4 правила), Domain Events + Outbox, Event Sourcing, CQRS |
14 | [Load Balancing и High Availability](109-interview-preparation/14-load-balancing-ha.md) | L4/L7 LB, Nginx, Active-Passive/Active-Active, Leader Election, Failover (DNS/VIP/Patroni), RPO/RTO, Health Checks |
15 | [CAP Theorem и модели консистентности](109-interview-preparation/15-cap-theorem-consistency.md) | CAP (CP/AP), PACELC, Linearizability→Eventual, Read-Your-Writes, Raft, Gossip, Consensus |
...
**44 раздела, 200+ статей** по всем темам.
...
| 🖥️ 021 — Avalonia/XAML | 2 | Avalonia, MAUI, Uno, WPF vs Avalonia, библиотеки |
...
| 🎓 104 — Университеты мира | 6 | История, национальные системы, рейтинги, СНГ, сравнение моделей |
...
| 🏢 108 — Microsoft Dynamics 365 | 6 | D365 экосистема, F&O, BC, Power Platform, X++, миграция данных |
| 🎯 109 — Собеседование | 15 | .NET, синхронизация, GC, System Design, архитектура, алгоритмы, PostgreSQL, Kafka, NoSQL, шардирование, кеширование, DDD, HA, CAP |
